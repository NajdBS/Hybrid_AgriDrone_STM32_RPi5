...
#define MOTOR_SAFE_MAX       950     // Limit for testing
//#define MOTOR_CMD_MAX       600 	// Safety Limit for testing (max 60%)

/* Safety */
#define SAFETY_ANGLE_MAX    60.0f   // Max angle before auto-kill
